...
import Footer3__text from "./Footer3.module.css";
import Footer3__text2 from "./Footer3.module.css";
...
function Footer3() {
  return (
    <>
      <div className={Footer3__text.footer3__text}>
        <p>
        ...
        <div>
          <p className={Footer3__text2.footer3__text2}>
        ...
        <div className={Footer3__text3flex.footer3__text3flex}>
          <p className={Footer3__text3.footer3__text3}>
